...
能够运行本地命令的 AI 工具，可以通过 md2wechat 的 [Skill / CLI](https://github.com/geekjourneyx/md2wechat-skill) 接入内容工作流。不同工具的安装方法与使用记录请查看 [Guide](https://github.com/md2wechat/md2wechat-guide) 和 [Wiki](https://github.com/md2wechat/md2wechat-wiki)。
